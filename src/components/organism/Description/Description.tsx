	...
	return (
		<div className={styles.description}>
			...
			<div className={styles.cardsWrapper}>
				<Card
					cover={<img className='card-cover' alt="translate" src="https://englex.ru/app/uploads/books-in-english-1.png" />}
				...
				<Card
					cover={<img className='card-cover' alt="dictionary" src="https://englex.ru/app/uploads/how-to-choose-english-dictionary.png" />}
					className={`card-description ${styles.card}`}
				>
				...
				<Card
					cover={<img className='card-cover' alt="training" src="https://englex.ru/app/uploads/english-for-trainers-and-athletes.png" />}
					className={`card-description ${styles.card}`}
				>
				...
				<Card
					cover={<img className='card-cover' alt="collections" src="https://englex.ru/app/uploads/surround-yourself-with-english.png" />}
					className={`card-description ${styles.card}`}
				>
